...
import com.neuqer.fitornot.business.mine.view.adapter.MyRequestAdapter;
 ...
 */
public class MyRequestActivity extends BasePresenterActivity<MineFragmentContract.Presenter> implements MineFragmentContract.View {
    ...
    private void processData(List<UserInfoModel> models){
        ...
        mAdapter=new MyRequestAdapter(this,models,R.layout.item_my_request);
